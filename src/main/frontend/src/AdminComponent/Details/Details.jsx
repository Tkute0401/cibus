              ...
              <div className="space-y-4 text-gray-200">
                <div className="flex">
                  ...
                  <p className="text-gray-400">
                    ...
                    {restaurant.userRestaurants?.owner.name}
                  </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-3 text-gray-200">
                <div className="flex">
                  ...
                  <p className="text-gray-400">
                    {" "}
                    <span className="pr-5">-</span>{" "}
                    {restaurant.userRestaurants?.address.country}
                  </p>
                </div>
                <div className="flex">
                  ...
                  <p className="text-gray-400">
                    {" "}
                    <span className="pr-5">-</span>{" "}
                    {restaurant.userRestaurants?.address.city}
                  </p>
                </div>
                <div className="flex">
                  ...
                  <p className="text-gray-400">
                    {" "}
                    <span className="pr-5">-</span>{" "}
                    {restaurant.userRestaurants?.address.postalCode}
                  </p>
                </div>
                <div className="flex">
                  ...
                  <p className="text-gray-400">
                    {" "}
                    <span className="pr-5">-</span>{" "}
                    {restaurant.userRestaurants?.address.streetAddress}
                  </p>
                </div>
              </div>
            </CardContent>
                ...
                <div className="flex items-center">
                  ...
                  <div className="text-gray-400 flex items-center pb-3">
                    ...
                    <a
                      target="_blank"
                      href={
                        restaurant.userRestaurants?.contactInformation.instagram
                      }
                      rel="noreferrer"
                    >
