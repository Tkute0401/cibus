...
const OrdersTable = ({ isDashboard, name }) => {
  ...
  const { restaurantsOrder, auth } = useSelector((Store) => Store);
                ...
                .map((item, index) => (
                  ...
                  {!isDashboard &&  <TableCell className="space-y-2">
                      ...
                      <div className="flex gap-1 flex-wrap">
                       { orderItem.food.ingredients.map((ingre) => (
                          <Chip label={ingre.name} />
                        ))}
                      </div>
                    ...
                    {!isDashboard &&<TableCell className="text-white">
                      <Chip
                        ...
                        label={item.orderStaus}
                        size="medium"
                        color={
                          item.orderStaus === "PENDING"
                            ? "info"
                            : item?.orderStaus === "DELIVERED"
                            ? "success"
                            : "secondary"
                        }
